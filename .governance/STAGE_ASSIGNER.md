...
| **Paths** | `src/services/DataService.js`, `scripts/static-dev-server.mjs` (default dev), `scripts/server.py` (POST handlers, `/config.js`), optional `scripts/server_secure.py` if used. |
